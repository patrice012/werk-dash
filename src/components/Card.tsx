...
export const Card = ({
  ...
  return (
    <div
      ...
      <div className="grid w-full grid-cols-[auto_1fr_auto] gap-[12px] items-center">
        {/* Image - largeur fixe */}
        ...
        <div className="flex flex-col gap-[2px] overflow-hidden">
          ...
          <span className="text-[#888888] text-[16px] truncate">
            Pixel Studio . Yogyakarta
          </span>
        </div>
      ...
      <div className="flex gap-[8px]">
        ...
        <div className="bg-[#e4fff1] px-[5px] py-[3px] text-[#4db06a] font-semibold text-[12px] rounded-[4px]">
          Hybrid
        </div>
        <div className="bg-[#ffede3] px-[5px] py-[3px] text-[#a97442] font-semibold text-[12px] rounded-[4px]">
          2-4 Years
        </div>
      </div>
