...
function HeroSection() {
  return (
    <div className="relative flex flex-col px-[24px] md:px-[50px] lg:px-[150px] pt-[50px] md:pt-[120px] pb-[50px] gap-[56px]">
      ...
      <img src="/assets/python.png"className="absolute top-[520px] left-[185px] "/>
      <img src="/assets/flutter.png"className="absolute top-[281px] right-[102px] "/>
      <img src="/assets/javascript.png"className="absolute top-[542px] right-[180px]"/>
      <div className=" flex flex-col gap-[36px] md:gap-[56px] items-center ">
        <div className="flex flex-col items-center">
          <span className="text-75-title text-center  font-[500] text-[#3EE1A6] ">
