...
export default function JobDetailsPage() {
  ...
  }, [DetailQuery, location?.state, params]);
    ...
    <>
      ...
      <div className="bg-[#f0f5fa] p-[15px] text-[#000] md:p-[30px]">
        <div className="xl:grid xl:grid-cols-4 flex flex-col-reverse gap-[12px] items-start">
          ...
          <div
            className={`grid gap-[12px] h-[100vh] sticky top-[20px] scrollbar scrollbar-thumb-[#d4d4d4]  scrollbar-w-[7px] scrollbar-thumb-rounded-full overflow-auto ${
              selectedJob != undefined && "grid"
            }`}
          >
            {AllQuery.isLoading &&
                  ...
                  <div className="flex w-full lm:hidden p-[15px] sm:p-[32px] ">
                    <div className="flex flex-col w-full gap-[24px]">
                      ...
                      <a
                        ...
                        target="_blank"
                        className="bg-[#0f7afd] hover:bg-[#2081ffd4] border-2 border-solid border-[#0f7afd] text-[#fff] px-[15px] rounded-full  w-full py-[12px] transition ease-in-out duration-500 text-center "
                      >
                        Apply now
                      </a>
                    </div>
                  ...
                  <div className=" w-full">
                    ...
                    <div className="w-full py-[20px] px-[15px] lg:px-[32px] flex">
                      <a
                        href={DetailQuery.data?.job[0]?.jobUrl}
                        target="_blank"
                        className="bg-[#0f7afd] hover:bg-[#2081ffd4] border-2 border-solid border-[#0f7afd] text-[#fff] font-[600] px-[15px] rounded-full  w-full py-[12px] transition ease-in-out duration-500 text-center"
                      >
                        Apply now
                      </a>
                    </div>
